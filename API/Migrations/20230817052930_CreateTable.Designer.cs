...
namespace API.Migrations
{
    ...
    [Migration("20230817052930_CreateTable")]
            ...
            modelBuilder.Entity("API.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4604),
                            ModifiedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4613),
                            Name = "Employee"
                        },
                        new
                        {
                            Guid = new Guid("4ec90656-e89c-4871-d9e5-08db8a7d0f37"),
                            CreatedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4615),
                            ModifiedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4616),
                            Name = "Trainer"
                        },
                        new
                        {
                            Guid = new Guid("c0689b0a-5c87-46f1-ce19-08db91a71ab9"),
                            CreatedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4618),
                            ModifiedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4618),
                            Name = "Operasional"
                        },
                        new
                        {
                            Guid = new Guid("5fb9adc0-7d08-45d4-cd66-08db9c7a678f"),
                            CreatedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4621),
                            ModifiedDate = new DateTime(2023, 8, 17, 12, 29, 30, 664, DateTimeKind.Local).AddTicks(4621),
                            Name = "Admin"
                        });
                });
